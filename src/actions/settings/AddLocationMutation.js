...
export default class AddLocationMutation extends Mutation {
  static fragments = {
  ...
  getVariables() {
    const locations = [...this.props.privateData.locations, this.props.location];
    return {
  ...
  getOptimisticResponse() {
    ...
    return {
      privateData: {
        id: privateData.id,
        locations: [...privateData.locations, this.props.location],
      },
    };
  }
}
