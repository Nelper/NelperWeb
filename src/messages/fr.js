export default {
  ...
  nelpcenter: {
    ...
    taskDetail: {
      status: "A TRADUIRE",
      offer: "A TRADUIRE",
      agreedPrice: "A TRADUIRE",
      amount: "A TRADUIRE",
      posted: "A TRADUIRE",
      accepted: "A TRADUIRE",
      requested: "A TRADUIRE",
      released: "A TRADUIRE",
      sent: "A TRADUIRE",
      ...
      paymentTo: "envoyé à {name}",
      paymentPlaceholderName: "Nom du détenteur",
      paymentPlaceholderCard: "Numéro de carte",
      paymentPlaceholderExpiry: "MM / AA",
      paymentPlaceholderCVC: "CVV",
      paymentPay: "Payer {amount}",
      paymentTerms: "Conditions d'utilisation",
      paymentErrorName: "Nom invalide",
      paymentErrorCard: "Numéro de carte invalide",
      paymentErrorExpiry: "Date d'expiration invalide",
      paymentErrorCVC: "CVV invalide",
      paymentError: "Une erreur est survenue. Veuillez réessayer.",
      paymentCompleted: "Paiement complété avec succès!",
    },
  ...
  faq: {
    ...
    posterDesc_01: "En appliquant sur votre tâche, un Nelper a l'option de faire sa propre offre de prix. Si vous le souhaitez, le prix que vous offrez en publiant votre tâche peut ne servir que de point de départ afin de négocier et parvenir à un prix équitable pour les deux parties.<br /><br />Il n’y a cependant pas de règles quant au montant que vous devriez débourser pour une tâche mais gardez en tête que le prix d'une tâche plus complexe ou plus longue à compléter devrait être plus élevé. Nous vous recommandons aussi de parcourir les tâches de la même catégorie dans {browseTasks} avant de publier la vôtre. Ainsi, vous aurez une meilleure idée de prix pour votre tâche.",
